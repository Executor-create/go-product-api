...
func newProduct(db *gorm.DB, opts ...gen.DOOption) product {
	...
	_product.URL = field.NewString(tableName, "url")
	_product.ImageURL = field.NewString(tableName, "image_url")
	_product.Description = field.NewString(tableName, "description")
	_product.Price = field.NewString(tableName, "price")
	_product.Rating = field.NewFloat64(tableName, "rating")
	_product.Summary = field.NewString(tableName, "summary")
	_product.CreatedAt = field.NewTime(tableName, "created_at")
	_product.UpdatedAt = field.NewTime(tableName, "updated_at")
	_product.Categories = field.NewString(tableName, "categories")
...
func (p *product) updateTableName(table string) *product {
	...
	p.Price = field.NewString(table, "price")
	p.Rating = field.NewFloat64(table, "rating")
	p.Summary = field.NewString(table, "summary")
	p.CreatedAt = field.NewTime(table, "created_at")
	p.UpdatedAt = field.NewTime(table, "updated_at")
	p.Categories = field.NewString(table, "categories")
