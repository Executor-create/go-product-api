...
func newReview(db *gorm.DB, opts ...gen.DOOption) review {
	...
	_review.ID = field.NewString(tableName, "id")
	_review.ProductID = field.NewString(tableName, "product_id")
	_review.Reviewer = field.NewString(tableName, "reviewer")
	_review.Rating = field.NewFloat64(tableName, "rating")
	_review.Pros = field.NewString(tableName, "pros")
	_review.Cons = field.NewString(tableName, "cons")
...
func (r *review) updateTableName(table string) *review {
	...
	r.Reviewer = field.NewString(table, "reviewer")
	r.Rating = field.NewFloat64(table, "rating")
	r.Pros = field.NewString(table, "pros")
	r.Cons = field.NewString(table, "cons")
...
func (r *review) fillFieldMap() {
	...
	r.fieldMap["reviewer"] = r.Reviewer
	r.fieldMap["rating"] = r.Rating
	r.fieldMap["pros"] = r.Pros
	r.fieldMap["cons"] = r.Cons
